package dev.mrsterner.aequivaleo.analysis;
...
public class AequivaleoReloadListener implements ResourceReloader {
	...
	private static final Identifier GENERAL_DATA_NAME = new Identifier(Constants.MOD_ID, "general");
	...
	private final ServerReloadableResources serverResources;
	private final Gson gson;

	public AequivaleoReloadListener(final ServerReloadableResources serverResources) {
